      ...
      return (
        <div className={classes.messageContainer} key={index}>
          <div className={message}>
            <Avatar className={classes.gridAreaAvatar} alt="Роджер Гилл" src="https://nashaplaneta.net/besopasnost/images/xmaccu-pikchu-selfi.jpg.pagespeed.ic._kKI--M36Z.jpg" />
